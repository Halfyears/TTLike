 ...
 *  - No <button> nested inside <a>/<Link> (invalid HTML)
 */
      ...
      <div className="relative w-full sm:max-w-lg bg-white rounded-t-3xl sm:rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="bg-gradient-to-br from-pink-500 via-violet-500 to-indigo-500 px-6 pt-8 pb-6 text-white">
          <div className="flex items-center gap-2 mb-1">
            ...
            <p id="upgrade-modal-title" className="font-bold text-lg">Monthly limit reached</p>
          </div>
          ...
          {/* Usage bar */}
          <div className="bg-white/20 rounded-full h-2 overflow-hidden" role="progressbar" aria-valuenow={pct} aria-valuemin={0} aria-valuemax={100}>
            <div
        ...
        <div className="px-4 py-5 grid grid-cols-2 gap-3">
          ...
          <div className="rounded-2xl border-2 border-pink-200 bg-pink-50 p-4 flex flex-col">
            ...
            {/* Single interactive element — no nested button/anchor */}
            <button
              type="button"
              onClick={() => navigate('/pricing?plan=creator')}
              className="w-full py-2 bg-gradient-to-r from-pink-500 to-violet-500 text-white text-xs font-bold rounded-xl hover:opacity-90 transition-opacity"
            >
              Get Creator
            </button>
          </div>
          ...
          <div className="rounded-2xl border-2 border-gray-200 bg-gray-50 p-4 flex flex-col">
            ...
            <button
              ...
              className="w-full py-2 bg-gray-800 text-white text-xs font-bold rounded-xl hover:bg-gray-700 transition-colors"
            >
              Get Scale
            </button>
          </div>
