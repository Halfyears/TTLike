    ...
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-8">Loved by TikTok Sellers</h2>
            ...
            {[
              ...
              <Card key={name} className="p-6 text-left">
                ...
                <div className="flex items-center gap-2">
                  <div className="h-8 w-8 rounded-full bg-pink-100 flex items-center justify-center text-pink-600 font-semibold text-sm">{name[0]}</div>
                  <div>
      ...
      {/* CTA */}
      <section className="py-16 bg-gradient-to-r from-pink-500 to-violet-600 text-white">
        <div className="mx-auto max-w-3xl px-4 text-center">
          <Users className="h-10 w-10 mx-auto mb-4 opacity-80" />
          <h2 className="text-3xl font-bold mb-3">Join 1,000+ TikTok Sellers in Beta</h2>
          <p className="text-pink-100 mb-8">Free during beta. No credit card. Cancel anytime.</p>
          <Link href="/auth/signup">
